...
extension DetailsController {
    func getDetails() {
        ...
        detailsData = [
            ...
            .init(name: "Last Paid Ammount", content: "\(accountDetails[0].generalInfo.lastPaidAmount)"),
            ...
            .init(name: "Credit Limit", content: "\(accountDetails[0].generalInfo.creditLimit)"),
        ...
        disputesData = [
            ...
            .init(name: "Transaction Amount", content: "\(disputes[0].transactionAmount)"),
            .init(name: "Transaction Due Amount", content: "\(disputes[0].transactionDueAmount)"),
            .init(name: "Approved Amount", content: "\(disputes[0].approvedAmount)"),
        ]
        ...
        invoicesData = [
            ...
            .init(name: "Transaction Amount", content: "\(invoices[0].transactionAmount)"),
            .init(name: "Transaction Due Amount", content: "\(invoices[0].transactionDueAmount)"),
        ]
        
        paymentsData = [
            .init(name: "Payment Number", content: payments[0].paymentNumber),
            .init(name: "Payment Date", content: payments[0].paymentDate),
            .init(name: "Payment Amount", content: "\(payments[0].paymentAmount)")
        ]
    }
}
